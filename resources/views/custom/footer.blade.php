            ...
            <div class="row">
                    ...
                    <div class="footer-widget footer-about">
                        ...
                        <div class="footer-about-content">
                            ...
                            <div class="social-icon">
                                <ul>
                                    <li>
                                        <a href="{{ $settings->site_fbLink }}" target="_blank"><i
                                                class="fab fa-facebook-f"></i> </a>
                                    </li>
                                    <li>
                                        <a href="{{ $settings->site_ytLink }}" target="_blank"><i
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="footer-widget footer-menu">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('search.doctor') }}"><i class="fas fa-angle-double-right"></i> Search
                                    for Doctors</a></li>
                            <li><a href="{{ route('contact.doctor_form') }}"><i class="fas fa-angle-double-right"></i>
                                    Doctor at Home</a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="footer-widget footer-menu">
                        ...
                        <ul>
                            <li><a href=" {{ route('login') }} "><i class="fas fa-angle-double-right"></i>Doctor
                                    Login</a></li>
                            <li><a href=" {{ route('doctorSignUpForm') }} "><i class="fas fa-angle-double-right"></i>Doctor
                                    Register</a></li>
