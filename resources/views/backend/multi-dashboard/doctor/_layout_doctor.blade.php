																...
																<tbody>
																		...
																		<td>
																			<h2 class="table-avatar">
																				<a href="patient-profile.php" class="avatar avatar-sm mr-2">
                                                                                    <img class="avatar-img rounded-circle" src="{{ asset('/') }}frontend/assets/img/patients/patient.jpg" alt="User Image"></a>
																	...
																	<tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="patient-profile.php" class="avatar avatar-sm mr-2">
                                                                                    <img class="avatar-img rounded-circle" src="{{ asset('/') }}frontend/assets/img/patients/patient3.jpg" alt="User Image"></a>
																	...
																	<tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="patient-profile.php" class="avatar avatar-sm mr-2">
                                                                                <img class="avatar-img rounded-circle" src="{{asset('')}}frontend/assets/img/patients/patient4.jpg" alt="User Image"></a>
																	...
																	<tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="patient-profile.php" class="avatar avatar-sm mr-2">
                                                                                    <img class="avatar-img rounded-circle" src="{{asset('')}}frontend/assets/img/patients/patient5.jpg" alt="User Image"></a>
