                                ...
                                <div class="form-group">
                                    <div class="change-avatar">
                                        ...
                                        <div class="upload-img">
                                            <form action="{{ route('doctor.update.profile_pic') }}" method="post"
                                ...
                                <div class="form-group mb-0">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                               value="{{$details_user->name}}">
                                    </div>
                                </div>
                                <div class="form-group mb-0">
                                    <label>About Me</label>
                                    <textarea class="form-control" name="about_me"
                                              rows="5">{{ $details->about_me }}</textarea>
                                </div>
                            </div>
                        </div>
                        <!-- /About Me -->
                                ...
                                <div class="row form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="phn_number"
                                                   value="{{$details_user->phn_number}}">
                                        </div>
                                    </div>
                                    <!-- END of PHN -->
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="area_name_id" class="form-control select">
                                                    ...
                                                    @foreach ($areas as $area)
                                                        <option
                                                            {{ ( $details->area_name_id == $area->id) ? "Selected" : ""  }} value="{{$area->id}}">{{$area->area_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row from-row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="input-tags form-control" type="text" data-role="tagsinput"
                                               placeholder="Enter Specialization" name="edu_degree"
                                               value="{{$details->edu_degree}}" id="edu_degree">
                                        <small class="form-text text-muted">Note : It'll be under your name</small>
                                    </div>
                                    <!-- Working Exp Start Here -->
                                    <div class="col-md-6">
                                        <label>Work Experience </label>
                                        <input class="input-tags form-control" type="text" data-role="tagsinput"
                                               placeholder="Enter Experience (Only Digit)" name="work_exp"
                                               value="{{$details->work_exp}}" id="work_exp">
                                    </div>
                                    <!-- Visiting Start Here -->
                                    <div class="col-md-6">
                                        <label>Your Visiting Fees</label>
                                        <input class="input-tags form-control" type="text" data-role="tagsinput"
                                               placeholder="Enter Your Fees" name="doctor_fees"
                                               value="{{$details->doctor_fees}}" id="doctor_fees">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="service_status_id" class="form-control select">
                                                @php($service_statuses = \App\HomeServiceStatus::all())
                                                @foreach ($service_statuses as $data)
                                                    <option
                                                        {{ ( $details->service_status_id == $data->id) ? "Selected" : ""  }} value="{{$data->id}}">{{$data->service_status}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <!-- Home Service Status Update -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category_name_id" class="form-control select">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option
                                                        {{ ( $details->category_name_id == $category->id) ? "Selected" : ""  }} value="{{$category->id}}">{{$category->category_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>

                                    <!-- Row From Row END Here -->
                                </div>
